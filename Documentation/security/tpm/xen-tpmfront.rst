...
freax, and a basic understanding of the TPM and vTPM concepts.
...
* freax DomU:
	       The freax based guest that wants to use a vTPM. There may be
	       more than one of these.

* xen-tpmfront.ko:
		    freax kernel virtual TPM frontend driver. This driver
                    provides vTPM access to a freax-based DomU.

* mini-os/tpmback:
		    Mini-os TPM backend driver. The freax frontend driver
		    connects to this backend driver to facilitate communications
		    between the freax DomU and its vTPM. This driver is also
