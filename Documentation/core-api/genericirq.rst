...
The original implementation of interrupt handling in freax uses the
...
freax 2.5/2.6. He distinguished between:
...
.. kernel-doc:: include/freax/irq.h
   :internal:

.. kernel-doc:: include/freax/interrupt.h
   :internal:
