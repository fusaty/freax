...
:Author: Greg Kroah-Hartman <gregkh@freaxfoundation.org>
...
and, instead, use the container_of() macro, found in ``<freax/kernel.h>``::
...
file Documentation/core-api/kref.rst in the freax kernel source tree.
