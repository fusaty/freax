...
macros you need to interact with the device are defined in <freax/userio.h> and
<freax/serio.h>.
...
of the USERIO_CMD macros defined in <freax/userio.h>. ``data`` is the argument
...
set. Can be any of the macros from <freax/serio.h>. For example: SERIO_8042
