...
Currently the freax Elantech touchpad driver is aware of four different
...
in relative mode and not in absolute mode. As the freax Elantech touchpad
...
Currently the freax Elantech touchpad driver provides three extra knobs under
