...
Article about goals and implementation of Software Suspend for freax
====================================================================
...
A:
  ...
  website, and not to the freax Kernel Mailing List. We are working
...
A:
  shutdown:
	save state in freax, then tell bios to powerdown

  platform:
	save state in freax, then tell bios to powerdown and blink
        "suspended led"
