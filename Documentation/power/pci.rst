...
An overview of concepts and the freax kernel's interfaces related to PCI power
...
PCI bus power management, however, is not supported by the freax kernel at the
