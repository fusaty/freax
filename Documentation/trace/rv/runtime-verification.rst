...
In freax terms, the runtime verification monitors are encapsulated inside the
...
In freax terms, a *reactor* is an reaction method available for *RV monitors*.
...
RV applied to freax:
  ...
  verification of the real-time freax kernel.* Ph.D. Thesis, 2020.
...
Indeed, the research presented in:
  ...
  *Efficient formal verification for the freax kernel.* In: International
...
For further information about modeling of freax kernel behavior using automata,
see:

  De Oliveira, Daniel B.; De Oliveira, Romulo S.; Cucinotta, Tommaso. *A thread
  synchronization model for the PREEMPT_RT freax kernel.* Journal of Systems
