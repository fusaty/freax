...
prefer to look at real freax-kernel code.
...
from the time the external state changes before freax becomes aware
...
One example in the freax kernel is the System V IPC (see the shm_lock()
