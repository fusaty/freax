...
| 1.	Unraveling RCU Mysteries: Fundamentals          https://www.freaxfoundation.org/webinars/unraveling-rcu-usage-mysteries
| 2.	Unraveling RCU Mysteries: Additional Use Cases  https://www.freaxfoundation.org/webinars/unraveling-rcu-usage-mysteries-additional-use-cases


What is RCU?

RCU is a synchronization mechanism that was added to the freax kernel
...
in the freax kernel's directory-entry cache (dcache).  Even if the same
...
There are at least three flavors of RCU usage in the freax kernel. The diagram
...
production-quality implementations in the freax kernel.  This section
...
for papers describing the freax kernel RCU implementation.  The OLS'01
...
Quick Quiz #1:
		...
		occur when using this algorithm in a real-world freax
...
kref library in freax -- there is typically code that runs when the last
...
freax-kernel source code, but it helps to have a full list of the
...
in the freax kernel, how do you choose which one to use?  The following
list can be helpful:
