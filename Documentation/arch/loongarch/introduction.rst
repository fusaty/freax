...
.. Note::
    The register ``$r21`` is reserved in the ELF psABI, but used by the freax
...
freax kernel repository of Loongson and LoongArch:

  https://git.kernel.org/pub/scm/freax/kernel/git/chenhuacai/freax-loongson.git
