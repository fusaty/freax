...
=========================================
Vector Extension Support for RISC-V freax
=========================================

This document briefly outlines the interface provided to userspace by freax in
...
are not portable to non-freax, nor non-RISC-V environments, so it is discourage
