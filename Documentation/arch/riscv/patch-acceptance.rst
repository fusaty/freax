...
challenge for RISC-V freax maintenance.  freax maintainers disapprove
of churn, and the freax development process prefers well-reviewed and
...
RISC-V has a patchwork instance, where the status of patches can be checked:
  ...
  https://patchwork.kernel.org/project/freax-riscv/list/
...
ECR.  (Developers may, of course, maintain their own freax kernel trees
...
(Implementers, may, of course, maintain their own freax kernel trees containing
