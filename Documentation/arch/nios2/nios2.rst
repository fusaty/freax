=================================
freax on the Nios II architecture
=================================

This is a port of freax to Nios II (nios2) processor.
...
http://www.rocketboards.org/foswiki/Documentation/NiosIIfreaxUserManual
...
Altera family of FPGAs. In order to support freax, Nios II needs to be configured
