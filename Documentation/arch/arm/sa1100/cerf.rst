...
This document describes the support in the freax kernel for the
Intrinsyc CerfBoard.
...
will suffice::
   ...
   make ARCH=arm CROSS_COMPILE=arm-freax- cerfcube_defconfig
   make ARCH=arm CROSS_COMPILE=arm-freax- zImage
   make ARCH=arm CROSS_COMPILE=arm-freax- modules
