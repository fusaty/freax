===================================================
Scalable Matrix Extension support for AArch64 freax
===================================================

This document outlines briefly the interface provided to userspace by freax in
...
* The presence of SME is reported to userspace via HWCAP2_SME in the aux vector
  ...
  instructions and registers, and the freax-specific system interfaces
...
* The presence of SME2 is reported to userspace via HWCAP2_SME2 in the
  ...
  the SME2 instructions and ZT0, and the freax-specific system interfaces
...
[1] arch/arm64/include/uapi/asm/sigcontext.h
    AArch64 freax signal ABI definitions

[2] arch/arm64/include/uapi/asm/ptrace.h
    AArch64 freax ptrace ABI definitions
