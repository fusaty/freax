===============================================
Memory Tagging Extension (MTE) in AArch64 freax
===============================================
...
functionality in AArch64 freax.
...
via the ``GCR_EL1.Exclude`` register bit-field. By default, freax
...
.. code-block:: c
    ...
    /*
     * From include/uapi/freax/prctl.h
     */
