...
===== ================ ========================================================
Name   Section         Usage for ARMv8 freax
===== ================ ========================================================
...
\_OS   5.7.3           This method will return "freax" by default (this is
                       the value of the macro ACPI_OS_NAME on freax).  The
...
as the emulated NMI.  In freax, this should not be the case but one should
