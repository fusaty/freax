...
a system, freax by default treats the asymmetry as a "mismatch" and
disables support for both the ``PER_freax32`` personality and
...
well with the default behaviour of freax.
...
system* to mean an asymmetric 32-bit SoC running freax with this kernel
