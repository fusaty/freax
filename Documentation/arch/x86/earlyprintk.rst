...
=====================
  ...
  a) On the host/target system:
    ...
    .. note::
      ...
      append it to the 'freax' line in /boot/grub2/grub.cfg. If you are
      using Grub2 on an EFI firmware system, append it to the 'freax'
      or 'freaxefi' line in /boot/grub2/grub.cfg or
...
If it does not work then please ask about it on the freax-kernel@vger.kernel.org
