...
In older versions of freax this was done with the
...
hardware present in every freax-capable CPU handle this test.
...
To understand this we have to look at the final kernel::
 ...
 > objdump --section-headers vmfreax
 >
 > vmfreax:     file format elf32-i386
 >
 > Sections:
...
final kernel executable::
 ...
 > objdump --disassemble --section=.text vmfreax
 >
...
of the executable file::
 ...
 > objdump --disassemble --section=.fixup vmfreax
 >
...
And finally::
 ...
 > objdump --full-contents --section=__ex_table vmfreax
 >
...
and linked in vmfreax     : > c017e7a5 <do_con_write+e1> movb   (%ebx),%dl
...
and linked in vmfreax     : > c0199ff5 <.fixup+10b5> movl   $0xfffffff2,%eax
...
Things changed when 64-bit support was added to x86 freax. Rather than
