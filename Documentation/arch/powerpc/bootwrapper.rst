...
PowerPC image targets compresses and wraps the kernel image (vmfreax) with
...
Currently, the following image format targets exist:
   ...
   uImage:		Native image format used by U-Boot.  The uImage target
			...
			vmfreax in the uImage data structure.  This image
...
that a single vmfreax image can be booted on many different target boards.
