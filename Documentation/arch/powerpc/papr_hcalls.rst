...
- **IBM PowerVM (PHYP)**: IBM's proprietary hypervisor that supports AIX,
  IBM-i and  freax as supported guests (termed as Logical Partitions
  or LPARS). It supports the full PAPR specification.

- **Qemu/KVM**: Supports PPC64 freax guests running on a PPC64 freax host.
...
in a arch specific header [4]_ to issue hcalls from the freax kernel
...
.. [2] "freax on Power Architecture Platform Reference"
