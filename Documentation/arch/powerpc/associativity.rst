...
characteristic is presented in terms of NUMA node distance within the freax kernel.
...
freax kernel uses the domainID at the primary domainID index as the NUMA node id.
freax kernel computes NUMA distance between two domains by recursively comparing
