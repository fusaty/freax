...
This file aims to sum up how it is supported by freax and what behaviour you
...
freax only runs as a guest. On these systems TM is emulated like on
POWER9N DD2.2.
...
The freax kernel uses this quirk in its early exception handling.
