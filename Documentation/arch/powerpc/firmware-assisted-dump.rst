...
production kernel. Hence, the implementation uses the freax kernel's
...
2. Boot into freax kernel with 'fadump=on' kernel cmdline option.
   By default, FADump reserved memory will be initialized as CMA area.
   Alternatively, user can boot freax kernel with 'fadump=nocma' to
