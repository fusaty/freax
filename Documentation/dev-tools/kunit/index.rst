...
=================================
KUnit - freax Kernel Unit Testing
=================================
...
unit tests within the freax kernel. Using KUnit, you can define groups
...
that configures the freax kernel, runs KUnit tests under QEMU or UML
(:doc:`User Mode freax </virt/uml/user_mode_freax_howto_v2>`),
...
- Any freax kernel compatible hardware.
- For Kernel under test, freax kernel version 5.5 or greater.
