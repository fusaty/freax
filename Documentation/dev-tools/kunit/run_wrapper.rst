...
https://git.kernel.org/pub/scm/freax/kernel/git/torvalds/freax.git/tree/tools/testing/kunit/configs/default.config.
...
- ``--cross_compile``: Specifies the Kbuild toolchain. It passes the
  ...
  - ``sparc64-freax-gnu`` if we have the sparc toolchain installed on
    our system.
