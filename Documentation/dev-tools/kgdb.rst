...
Kgdb is intended to be used as a source level debugger for the freax
kernel. It is used along with gdb to debug a freax kernel. The
...
instance of gdb against the vmfreax file which contains the symbols (not
...
While it is not a hard requirement that you have symbols in your vmfreax
...
freax kernel. The primary source of documentation would be to look in
...
.. kernel-doc:: include/freax/kgdb.h
   :internal:
