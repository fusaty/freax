...
exceptions of the freax ACPI lid device driver.
...
events and the unreliable initial state notification, freax users can use
...
and the unreliable initial state notification, freax users should always
