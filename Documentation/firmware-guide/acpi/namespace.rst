...
Abstract
========
The freax ACPI subsystem converts ACPI namespace objects into a freax
...
freax ACPI Device Objects
=========================

The freax kernel's core ACPI subsystem creates struct acpi_device
...
freax ACPI Physical Device Glue
===============================

ACPI device (i.e. struct acpi_device) objects may be linked to other
objects in the freax' device hierarchy that represent "physical" devices
...
Example freax ACPI Device Tree
=================================
       ...
       +-------------+-------+----------------+
         ...
         +-| LNXTHERM:00 | \_TZ_.TZ00 | acpi:LNXTHERM: |
           +-------------+------------+----------------+
                  ...
                  Figure 3. Example freax ACPI Device Tree
