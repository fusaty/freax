...
:Author: - Sean V Kelley <sean.v.kelley@freax.intel.com>
...
interrupt goes unhandled over time, they are tracked by the freax kernel as
Spurious Interrupts. The IRQ will be disabled by the freax kernel after it
...
disabled, the freax kernel will reroute the valid interrupt to its legacy
