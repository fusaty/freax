...
In existing freax kernels, the freax Device Driver Model allows a
...
PCI device drivers are implemented based on freax Device Driver Model.
...
header file /include/freax/pcieport_if.h, before calling these APIs.
...
This API replaces the freax Driver Model's pci_register_driver API. A
...
pcie_port_service_unregister replaces the freax Driver Model's
