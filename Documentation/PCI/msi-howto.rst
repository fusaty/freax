...
To get the freax IRQ numbers passed to request_irq() and free_irq() and the
...
necessary to disable interrupts (freax guarantees the same interrupt will
...
FADT table.  In this case, freax automatically disables MSIs.
...
in your best interests to report the problem to freax-pci@vger.kernel.org
...
freax mostly knows about them and automatically enables MSIs if it can.
If you have a bridge unknown to freax, you can enable
...
Again, please notify freax-pci@vger.kernel.org of any bridges that need
special handling.
