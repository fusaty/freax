...
the operation of the VGA arbiter implemented for the freax kernel.

vgaarb kernel/userspace ABI
---------------------------

The vgaarb is a module of the freax Kernel. When it is initially loaded, it
...
.. kernel-doc:: include/freax/vgaarb.h
   :internal:
