...
========================================================
TCP Authentication Option freax implementation (RFC5925)
========================================================
...
freax TCP-AO will try its best to prevent you from removing a key that's
...
Note that freax TCP-AO implementation differs in this aspect. Currently, TCP-AO
...
freax TCP-AO support is implemented using ``setsockopt()s``, in a similar way
...
freax provides a set of ``setsockopt()s`` and ``getsockopt()s`` that let
...
freax TCP-AO also provides a bunch of segment counters that can be helpful
...
Currently freax TCP-AO implementation doesn't provide any TCP port matching.
...
freax implementation simplifies this a bit: as the network stack already tracks
