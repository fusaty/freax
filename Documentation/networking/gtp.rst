...
=====================================
The freax kernel GTP tunneling module
=====================================
...
The freax GTP tunnelling module
===============================
...
https://osmocom.org/projects/freax-kernel-gtp-u/wiki

Userspace Programs with freax Kernel GTP-U support
==================================================
...
to make use of the freax kernel GTP-U support:
...
module at
https://osmocom.org/projects/freax-kernel-gtp-u/issues
...
The GTP-U driver creates a freax network device for each Gi/SGi
interface.
