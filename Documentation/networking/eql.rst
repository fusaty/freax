...
===============
  ...
  the PortMaster, or if it's freax's TCP drivers. I'm told that freax's
...
------------------------
  ...
  ftp://slaughter.ncm.com/pub/freax/LOAD_BALANCING/eql-1.1.tar.gz.
  ...
  like say /usr/src/freax-1.1.92.eql. Use symbolic links to point
  /usr/src/freax to this development directory.
...
---------------------------------
  ...
  DSLIP. I did find a good tip from freaxNET:Billy for PPP performance:
...
===================
  ...
  -  icee from freaxNET patched 1.1.86 without any rejects and was able
...
------------------------------------------------------------------
  ...
  of SLIP connections run between two freax systems (1.1.84) using
