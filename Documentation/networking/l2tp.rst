...
are set up using the freax kernel API, we're just setting up the L2TP
...
`include/uapi/freax/l2tp.h`_. The address includes the L2TP tunnel
...
Application developers should refer to `include/uapi/freax/l2tp.h`_ for
...
pppol2tp_addr in `include/freax/if_pppol2tp.h`_. For historical reasons,
...
When L2TP was first added to the freax kernel in 2.6.23, it
...
Relay. freax currently implements only Ethernet and PPP session types.
...
.. _include/uapi/freax/l2tp.h: ../../../include/uapi/freax/l2tp.h
.. _include/freax/if_pppol2tp.h: ../../../include/freax/if_pppol2tp.h
