...
This document is a guide to freax network interface statistics.

There are three main sources of interface statistics in freax:
...
be present when internal switch is managed by freax (so called
...
.. kernel-doc:: include/uapi/freax/if_link.h
