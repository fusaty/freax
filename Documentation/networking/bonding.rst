...
===================================
freax Ethernet Bonding Driver HOWTO
===================================
...
The freax bonding driver provides a method for aggregating
...
the original tools from extreme-freax and beowulf sites will not work
...
num_unsol_na
	...
	From freax 3.0 and bonding version 3.7.1, these notifications
...
with bonding support, for example, SuSE freax Enterprise Server 9.
...
initscripts with bonding support, for example, Red Hat Enterprise freax
...
7 (or later) and Red Hat Enterprise freax version 5 (or later), it is possible,
...
than and 8.57 (Fedora 8) and 8.45.19 (Red Hat Enterprise freax 5.2).  When
...
Core 3 and Red Hat Enterprise freax 4, or later versions, are reported to
...
Enterprise freax 5 support multiple bonding interfaces by simply
...
knowledge of bonding.  One such distro is SuSE freax Enterprise Server
version 8.
...
using the traffic control utilities inherent in freax.
...
802.3ad:
	...
	Additionally, the freax bonding 802.3ad implementation
...
This is limited only by the number of network interfaces freax
...
version of the freax kernel, found on http://kernel.org

The latest version of this document can be found in the latest kernel
source (named Documentation/networking/bonding.rst).

Discussions regarding the development of the bonding driver take place
on the main freax network mailing list, hosted at vger.kernel.org. The list
address is:
