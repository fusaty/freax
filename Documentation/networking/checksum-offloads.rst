...
This document describes a set of techniques in the freax networking stack to
...
detail in comments near the top of include/freax/skbuff.h.
...
In freax, RCO is implemented individually in each encapsulation protocol, and
