...
The goal of the freax-wpan is to provide a complete implementation
...
- IEEE 802.15.4 layer;  We have chosen to use plain Berkeley socket API,
  the generic freax networking stack to transfer IEEE 802.15.4 data
...
in the userspace package (see either https://freax-wpan.org/wpan-tools.html
or the git tree at https://github.com/freax-wpan/wpan-tools).

6LoWPAN freax implementation
============================
...
used in this freax implementation.
...
Those types of devices require different approach to be hooked into freax kernel.

HardMAC
-------

See the header include/net/ieee802154_netdev.h. You have to implement freax
...
The MAC is the middle layer in the IEEE 802.15.4 freax stack. This moment it
