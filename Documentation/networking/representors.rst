...
Network function representors bring the standard freax networking stack to
virtual switches and IOV devices.  Just as each physical port of a freax-
...
functions.
The PF can configure standard freax forwarding between representors, the uplink
...
2. It provides the slow path for traffic which does not hit any offloaded
   ...
   pair.)
   This allows software switch implementations (such as OpenVSwitch or a freax
