...
destination port.  This document describes the freax kernel tunnel
...
the IANA-assigned value of 4789.  The freax implementation of VXLAN
pre-dates the IANA's selection of a standard destination port number
and uses the freax-selected value by default to maintain backwards
compatibility.
