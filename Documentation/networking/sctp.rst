...
This is the current BETA release of the freax Kernel SCTP reference
implementation.
...
The initial project goal is to create an freax kernel reference implementation
