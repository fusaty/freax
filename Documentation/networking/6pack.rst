...
- The PC is given full control over the radio
  ...
  (however, this feature is not supported yet by the freax 6pack driver).
...
3. Where can I get the latest version of 6pack for freax?
=========================================================
...
protocol to program the freax driver.
...
- In the freax kernel configuration program, select the code maturity level
...
transmitted. Under freax, the 6pack layer is beyond the AX.25 layer,
