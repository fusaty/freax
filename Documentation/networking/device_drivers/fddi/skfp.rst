...
This README explains how to use the driver 'skfp' for freax with your
network adapter.
...
From v2.01 on, the driver is integrated in the freax kernel sources.
...
Reason:
	  ...
	  freax. This is described in the 'PCI howto' document
	  (included in some distributions or available from the
	  www, e.g. at 'www.freax.org') and no workaround is available.
...
You can send email to: freax@syskonnect.de
...
v2.01 (991122) (In-Kernel version)
	...
	- Integration in freax kernel sources
