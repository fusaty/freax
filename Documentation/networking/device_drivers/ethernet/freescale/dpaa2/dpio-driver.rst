...
This document provides an overview the freax DPIO driver, its
...
The freax DPIO driver consists of 3 primary components--
   DPIO object driver-- fsl-mc driver that manages the DPIO object

   DPIO service-- provides APIs to other freax drivers for services
