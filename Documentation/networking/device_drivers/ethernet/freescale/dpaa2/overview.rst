...
and how it is integrated into the freax kernel.
...
DPAA2 freax Drivers Overview
============================

This section provides an overview of the freax kernel drivers for
...
bus controller.
Each object in the DPRC is a freax "device" and is bound to a driver.
The diagram below shows the freax drivers involved in a networking
...
the network stack.
Each DPNI corresponds to a freax network interface.
