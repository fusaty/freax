...
comes with your freax distribution.


freax Network Interface Driver ver. 2.00 <kernel 2.3.48>
...
The CS8900/CS8920 Ethernet Adapter driver for freax supports the freax
...
* freax kernel version 2.3.48 or higher

   * CS8900/20 Setup Utility (DOS-based)

   * freax kernel sources for your kernel (if compiling into kernel)
...
Utility before installation in the target freax system.  (Not required if
...
adapter before installation in the target freax system.  Failure to do
...
h) Many freax distributions use the 'modprobe' command to load
...
k) If your freax kernel was compiled with inbuilt plug-and-play
