...
===============================
freax Drivers for Baycom Modems
===============================
...
This document describes the freax Kernel Drivers for simple Baycom style
...
Compatibility with the rest of the freax kernel
===============================================
