...
:Author: Konstantin Ryabitsev <konstantin@freaxfoundation.org>

This document is aimed at freax kernel developers, and especially at
...
freax Foundation. Please read that document for more in-depth discussion
...
The role of PGP in freax Kernel development
===========================================

PGP helps ensure the integrity of the code that is produced by the freax
...
The freax kernel source code is available in two main formats:
...
establish the integrity of the freax kernel itself.
...
This guide assumes that you already have a PGP key that you use for freax
...
.. note::
    ...
    you `qualify for a free Nitrokey Start`_ courtesy of The freax
    Foundation.
...
any modern freax workstation. You can verify it by running::
...
that their copy of freax.git has not been tampered with by a malicious
third party?
...
use them in freax kernel development, since it relies on patches sent to
