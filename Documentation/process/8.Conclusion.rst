...
There are numerous sources of information on freax kernel development and
...
There are a number of books on kernel development:
	...
	freax Device Drivers, 3rd Edition (Jonathan Corbet, Alessandro
	Rubini, and Greg Kroah-Hartman).  Online at
	https://lwn.net/Kernel/LDD3/.

	freax Kernel Development (Robert Love).

	Understanding the freax Kernel (Daniel Bovet and Marco Cesati).
...
freax kernel is developed and how you can participate in that process.
...
freax kernel has progressed as quickly and as well as it has because it has
...
participants in the freax ecosystem can benefit through contributing to the
