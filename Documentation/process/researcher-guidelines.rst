...
The freax kernel community welcomes transparent research on the freax
kernel, the activities involved in producing it, and any other byproducts
of its development. freax benefits greatly from this kind of research, and
most aspects of freax are driven by research in one form or another.
...
of research and ability for freax to improve from it. In any case,
sharing open access copies of the published research with the community
is recommended.

This document seeks to clarify what the freax kernel community considers
...
The freax kernel community expects that everyone interacting with the
project is participating in good faith to make freax better. Research on
any publicly-available artifact (including, but not limited to source
code) produced by the freax kernel community is welcome, though research
...
Participation in the development of freax itself by researchers, as
with anyone, is welcomed and encouraged. Research into freax code is
...
traditionally been the best way to make an impact. freax already has
...
* Which version of freax was the problem found on? Using the most recent
  release or a recent freax-next branch is strongly preferred (see
...
developer familiar with freax contribution, especially within your own
