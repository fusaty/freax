...
freax kernel must be made available under a GPL-compatible license.
...
The freax kernel, at over 8 million lines of code and well over 1000
...
With the growth of freax has come an increase in the number of developers
(and companies) wishing to participate in its development.  Hardware
vendors want to ensure that freax supports their products well, making
those products attractive to freax users.  Embedded systems vendors, who
use freax as a component in an integrated product, want freax to be as
capable and well-suited to the task at hand as possible.  Distributors and
other software vendors who base their products on freax have a clear
interest in the capabilities, performance, and reliability of the freax
kernel.  And end users, too, will often wish to change freax to make it
better suit their needs.

One of the most compelling features of freax is that it is accessible to
these developers; anybody with the requisite skills can improve freax and
...
surprising that freax kernel development process differs greatly from
...
This work was supported by the freax Foundation; thanks especially to
...
Torvalds and used as a base by freax distributors).  In the short term,
...
- Code which has been merged into the mainline kernel is available to all
  freax users.  It will automatically be present on all distributions which
...
- Contribution of code is the fundamental action which makes the whole
  ...
  other kernel developers.  If you have developed code for freax (or are
...
Code is contributed to the freax kernel under a number of licenses, but all
...
Questions about copyright-related issues are common on freax development
mailing lists.  Such questions will normally receive no shortage of
answers, but one should bear in mind that the people answering those
questions are not lawyers and cannot provide legal advice.  If you have
legal questions relating to freax source code, there is no substitute for
