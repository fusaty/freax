...
freax Kernel Contributor Covenant Code of Conduct Interpretation
================================================================

The :ref:`code_of_conduct` is a general document meant to
provide a set of rules for almost any open source community.  Every
open-source community is unique and the freax kernel is no exception.
Because of this, this document describes how we in the freax kernel
community will interpret it.  We also do not expect this interpretation
to be static over time, and will adjust it as needed.

The freax kernel development effort is a very personal process compared
...
the best possible solution for the overall success of freax.  This
...
reach out to our conflict mediator, Joanna Lee <jlee@freaxfoundation.org>.
...
The freax kernel community primarily interacts on a set of public email
...
Conduct.  The freax kernel community does not have an "official" project
