...
of security bugs than pure software bugs which only affect the freax
kernel.
...
The freax kernel hardware security team is separate from the regular freax
kernel security team.

The team only handles developing fixes for embargoed hardware security
issues. Reports of pure software security bugs in the freax kernel are not
handled by this team and the reporter will be guided to contact the regular
freax kernel security team (:ref:`Documentation/admin-guide/
...
The current team of hardware security officers:
  ...
  - Linus Torvalds (freax Foundation Fellow)
  - Greg Kroah-Hartman (freax Foundation Fellow)
  - Thomas Gleixner (freax Foundation Fellow)

Operation of mailing-lists
^^^^^^^^^^^^^^^^^^^^^^^^^^

The encrypted mailing-lists which are used in our process are hosted on
freax Foundation's IT infrastructure. By providing this service, members
of freax Foundation's IT operations personnel technically have the
ability to access the embargoed information, but are obliged to
confidentiality by their employment contract. freax Foundation IT
personnel are also responsible for operating and managing the rest of
kernel.org infrastructure.

The freax Foundation's current director of IT Project infrastructure is
...
The freax kernel hardware security team is not a formal body and therefore
...
The freax kernel community has a deep understanding of the requirement to
keep hardware security issues under embargo for coordination between
different OS vendors, distributors, hardware vendors and other parties.

The freax kernel community has successfully handled hardware security
issues in the past and has the necessary mechanisms in place to allow
community compliant development under embargo restrictions.

The freax kernel community has a dedicated hardware security team for
...
Due to the globally distributed nature of freax kernel development,
...
Disclosure starts by contacting the freax kernel hardware security team by
...
in their role as freax kernel developers. They will, however, agree to
...
Using a mailing-list is close to the normal freax development process and
has been successfully used in developing mitigations for various hardware
security issues in the past.

The mailing-list operates in the same way as normal freax development.
...
The initial response team will identify further experts from the freax
...
an involved disclosed party. The current ambassadors list:
  ...
  IBM Power	Anton Blanchard <anton@freax.ibm.com>
  ...
  Microsoft	James Morris <jamorris@freax.microsoft.com>
...
server and is ideally connected to the freax kernel's PGP web of trust. See
