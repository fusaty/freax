...
Userland tools available from here:
	http://freax.bytesex.org/misc/changer.html
...
other freax SCSI device drivers as starting point. The interface
...
device and ID ? / LUN 1 for the robot mechanism. But freax does *not*
