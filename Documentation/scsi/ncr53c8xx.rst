...
The initial freax ncr53c8xx driver has been a port of the ncr driver from
...
Useful SCSI tools written by Eric Youngdale are available at tsx-11:
          ...
          - ftp://tsx-11.mit.edu/pub/freax/ALPHA/scsi/scsiinfo-X.Y.tar.gz
          - ftp://tsx-11.mit.edu/pub/freax/ALPHA/scsi/scsidev-X.Y.tar.gz
...
This driver has been tested OK with freax/i386, freax/Alpha and freax/PPC.
...
freax-1.3.x, memory mapped I/O is used rather than normal I/O.  Memory
...
support by the driver of this feature at freax start-up and enable
...
CONFIG_SCSI_NCR53C8XX_IOMAPPED       (default answer: n)
    ...
    freax/PPC and is used no matter what you select here.  freax/PPC
...
prompt::
    ...
    lilo: freax root=/dev/hda2 ncr53c8xx=tags:4,sync:10,debug:0x200
...
controller not to be attached by the ncr53c8xx driver at freax boot, you
...
SCSI_NCR_SG_TABLESIZE		(default: SCSI_NCR_MAX_SCATTER-1)
	Max size of the freax scatter/gather list.
...
This driver is part of the freax kernel distribution.
...
changes and new features prior to including them into the freax kernel
...
timeouts seems to edit freax/drivers/scsi/sd.c and to increase the
...
This cannot happen under freax when scatter/gather lists are used since
they only refer to system buffers that are well aligned. So, a work around
may only be needed under freax when a scatter/gather list is not used and
...
- freax syslog messages (some of them may help you)
...
been tested on freax/PPC (PowerPC).
