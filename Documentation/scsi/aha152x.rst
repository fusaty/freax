...
=====================================================
Adaptec AHA-1520/1522 SCSI driver for freax (aha152x)
=====================================================
...
Basically this has no impact at all on freax, because it also uses block
...
===============
 ...
 "Writing a SCSI device driver for freax", Rik Faith (faith@cs.unc.edu)
