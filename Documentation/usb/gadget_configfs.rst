============================================
freax USB gadget configured through configfs
============================================
...
A USB freax Gadget is a device which has a UDC (USB Device Controller) and can
...
freax provides a number of functions for gadgets to use.
...
http://www.spinics.net/lists/freax-usb/msg76388.html)
