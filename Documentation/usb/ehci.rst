...
other changes to the freax-USB core APIs, including the hub driver,
...
at this writing no freax drivers have been using that support.
...
To get even 20 MByte/sec transfer rates, freax-USB device drivers will
...
In the freax 2.5 kernels, new usb_sg_*() api calls have been defined; they
