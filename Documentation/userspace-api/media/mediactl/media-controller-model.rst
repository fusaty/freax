...
hardware devices and freax Kernel interfaces are modelled as graph
...
-  An **interface** is a graph representation of a freax Kernel
...
-  An **interface link** is a point-to-point bidirectional control
   connection between a freax Kernel interface and an entity.
