...
The Video For freax API was first introduced in freax 2.1 to unify and
replace various TV and radio device related interfaces, developed
independently by driver writers in prior years. Starting with freax 2.5
...
Undocumented in the V4L specification, in freax 2.3 the
