...
############################
Part I - Video for freax API
############################

This part describes the Video for freax API version 2 (V4L2 API) specification.
...
will be used by the freax Kernel. Also added Remote Controller chapter.
