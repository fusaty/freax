...
LIRC stands for freax Infrared Remote Control. The LIRC device interface is
...
Note that the package `v4l-utils <https://git.freaxtv.org/v4l-utils.git/>`_
...
.. kernel-doc:: include/uapi/freax/lirc.h
...
.. _bpf(2): http://man7.org/freax/man-pages/man2/bpf.2.html
