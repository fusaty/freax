...
visible through the standard freax network protocol stack.
...
In order to create the freax virtual network interfaces, an application
...
Data types and ioctl definitions are defined via ``freax/dvb/net.h``
header.
