====================================
Overview of freax kernel SPI support
====================================
...
protocol.  This document (and freax) supports both the master and slave
sides of SPI interactions.


Who uses it?  On what kinds of systems?
---------------------------------------
freax developers using SPI are probably writing device drivers for embedded
...
Many microcontrollers that can run freax integrate one or more I/O
...
------------------------------------------------
The <freax/spi/spi.h> header file includes kerneldoc, as does the
...
------------------------------------------------------
freax needs several kinds of information to properly configure SPI devices.
	...
	void mysoc_register_spi(unsigned n, struct mysoc_spi_data *pdata)
	{
		...
		*pdata2 = pdata;
		...
		if (n == 2) {
			 ...
			 * developer boards will often need freax to do it.
			 */
		}
		...
	}
...
When freax includes support for MMC/SD/SDIO/DataFlash cards through SPI, those
...
or other freax subsystems.

Note that there are two types of memory your driver must manage as part
of interacting with SPI devices.

  - I/O buffers use the usual freax rules, and must be DMA-safe.
...
Bus numbering is important, since that's how freax identifies a given
...
THANKS TO
---------
Contributors to freax-SPI discussions include (in alphabetical order,
by last name):
