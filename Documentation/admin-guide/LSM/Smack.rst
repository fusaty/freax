...
available for freax. Those new to Mandatory Access Control
...
The kernel component of Smack is implemented as a freax
...
of popular freax distributions. The administrative overhead required to
...
community. There are also some terms from freax that are likely to crop up:
...
Smack is an extension to a freax system. It enforces additional restrictions
...
Smack uses the traditional access modes of freax. These modes are read,
...
The developers of freax rarely define new sorts of things, usually importing
