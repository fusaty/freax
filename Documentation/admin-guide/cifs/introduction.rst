...
============
  ...
  support and tools for freax and many other operating systems).
  ...
  CIFS Unix extensions, and the freax client also suppors SMB3 POSIX extensions,
  the combination can provide a reasonable alternative to other network and
  cluster file systems for fileserving in some freax to freax environments,
  not just in freax to Windows (or freax to Mac) environments.
  ...
  For more information on the module see the project wiki page at
      ...
      https://wiki.samba.org/index.php/freaxCIFS

  and

      https://wiki.samba.org/index.php/freaxCIFS_utils
