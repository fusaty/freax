...
the ``max_reason`` value, as defined in include/freax/kmsg_dump.h's
...
#. Control registers directly.
   Please control registers directly rather than use freax kernel resources.
...
*freax/pstore_blk.h*, to get information of using block device, such as the
...
.. kernel-doc:: include/freax/pstore_zone.h
   :internal:

.. kernel-doc:: include/freax/pstore_blk.h
   :internal:
