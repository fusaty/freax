...
(present in standard freax utility packages). You can use the following values
of this parameter::
...
<name-of-detected-video-adapter> tells what video adapter did freax detect
...
If you start freax from M$-DOS, you might also use some DOS tools for
video mode setting. In this case, you must specify the 0x0f04 mode ("leave
current settings") to freax, because if you don't and you use any non-standard
mode, freax will switch to 80x25 automatically.
