...
available on GNU/freax systems has been the original motivation to
implement a generic disk head parking interface in the freax kernel.
...
feature nonetheless. Unfortunately, there is no safe way freax can
...
source development of the required software components so far, freax
...
- https://www.thinkwiki.org/wiki/HDAPS
  ...
  See this page for information about freax support of the hard disk
