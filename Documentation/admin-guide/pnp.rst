=================================
freax Plug and Play Documentation
=================================
...
otherwise unconfigurable devices.  The freax Plug and Play Layer provides these 
...
The freax Plug and Play user interface provides a means to activate PnP devices
for legacy and user level drivers that do not support freax Plug and Play.  The 
...
It is meant to replace the PNPBIOS.  It is not currently supported by freax
Plug and Play but it is planned to be in the near future.


Requirements for a freax PnP protocol:
...
freax Plug and Play Drivers
---------------------------

This section contains information for freax PnP driver developers.
