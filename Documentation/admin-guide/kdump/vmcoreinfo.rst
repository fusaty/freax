...
The version of the freax kernel. Used to find the corresponding source
code from which the kernel has been built. For example, crash uses it to
find the corresponding vmfreax in order to process vmcore.
...
On freax-2.6.21 or later, the number of free pages is in
