...
The Spectre v2 mitigations protect the freax kernel, as it fills the return
...
context switch fills the RAP entries (referred to as the RSB in freax) with safe
