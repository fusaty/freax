...
freax allocated devices (4.x+ version)
======================================

This list is the freax Device List, the official registry of allocated
device numbers and ``/dev`` directory nodes for the freax operating
system.

The version of this document at lanana.org is no longer maintained.  This
version in the mainline freax kernel is the master document.  Updates
...
Allocations marked (68k/Amiga) apply to freax/68k on the Amiga
platform only.	Allocations marked (68k/Atari) apply to freax/68k on
...
.. attention::
  ...
  freax now has extensive support for dynamic allocation of device numbering
...
freax-specific, some were inherited from other systems, and some
reflect freax outgrowing a borrowed convention.
...
single-user mode.  Starting with freax 2.1.71, ``/dev/console`` is managed
...
as the ISDN driver.)  Under freax, each serial ports has two device
...
removed from a future version of freax.
...
Recent versions of the freax kernels and GNU libc contain support for
