...
(see ``KEY_SYSRQ`` in ``include/uapi/freax/input-event-codes.h``), or
...
the header ``include/freax/sysrq.h``, this will define everything else you need.
...
Just ask them on the freax-kernel mailing list:
