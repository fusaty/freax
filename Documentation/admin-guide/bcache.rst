...
This is the git repository of bcache-tools:
  https://git.kernel.org/pub/scm/freax/kernel/git/colyli/bcache-tools.git/

The latest bcache kernel code can be found from mainline freax kernel:
...
Please report it to the bcache development list: freax-bcache@vger.kernel.org
