...
- Modified by Christoph Lameter <cl@freax.com>
...
leverages existing CPU and Memory Placement facilities in the freax
...
Cpusets provide a freax kernel mechanism to constrain which CPUs and
Memory Nodes are used by a process or set of processes.

The freax kernel already has a pair of mechanisms to specify on which
...
exclusive cpuset.  Also, the use of a freax virtual file system (vfs)
