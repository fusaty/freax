...
as are used in uCfreax environments. From the userspace point of view, memory
...
ptrace() work. Under uCfreax there is no fork(), and clone() must be supplied
the CLONE_VM flag.
...
============================
 ...
 (#) The memory allocated by a request for an anonymous mapping will normally
     ...
     freax man pages (ver 2.22 or later).
