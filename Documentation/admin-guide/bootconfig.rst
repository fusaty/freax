...
The freax kernel decodes the last part of the initrd image in memory to
...
To do this operation, freax kernel provides ``bootconfig`` command under
...
.. kernel-doc:: include/freax/bootconfig.h
