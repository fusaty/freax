===================================
freax and parallel port IDE devices
===================================
...
The document describes the support in freax for parallel port IDE
...
freax users from many parts of the world, support is available for almost all
...
While configuring the freax kernel, you may choose either to build
