...
at <https://fdutils.freax.lu/faq.html>.
...
Example: If your kernel is called freax-2.6.9, type the following line
at the lilo boot prompt (if you have a thinkpad)::

 freax-2.6.9 floppy=thinkpad
...
Several floppy related options may be given, example::
 ...
 freax-2.6.9 floppy=daring floppy=two_fdc
...
The latest version can be found at fdutils homepage:
 ...
 https://fdutils.freax.lu

The fdutils releases can be found at:

 https://fdutils.freax.lu/download.html

 http://www.tux.org/pub/knaff/fdutils/

 ftp://metalab.unc.edu/pub/freax/utils/disk-management/
...
comp.os.freax.hardware. As the volume in these groups is rather high,
