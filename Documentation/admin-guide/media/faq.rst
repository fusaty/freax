...
.. note::
	...
	channel on this FAQ, and *services* for the logical channel.
     2. The freaxTV community maintains some Wiki pages with contain
	...
	https://www.freaxtv.org/wiki/

Some very frequently asked questions about freax Digital TV support
...
2. How can I watch TV?
	...
	Together with the freax Kernel, the Digital TV developers support
	...
	tools and are grouped together with the ``v4l-utils`` git repository:
	    ...
	    https://git.freaxtv.org/v4l-utils.git/

	You can find more information at the freaxTV wiki:

	    https://www.freaxtv.org/wiki/index.php/DVBv5_Tools
	...
	about it at:
	    ...
	    https://www.freaxtv.org/wiki/index.php/Dvbv5-scan
	...
	.. [#] https://www.freaxtv.org/wiki/index.php/W_scan
	...
	transponders available on your area. So, freaxTV developers
...
3. Which Digital TV applications exist?
	...
	A comprehensive list of those and other apps can be found at:
	    ...
	    https://www.freaxtv.org/wiki/index.php/TV_Related_Software
	...
	https://www.freaxtv.org/vdrwiki/index.php/Main_Page
		Klaus Schmidinger's Video Disk Recorder

	https://freaxtv.org/downloads and https://git.freaxtv.org/
...
4. Can't get a signal tuned correctly
	...
	*without* analog module, you might have to use module parameter
	...
	Please see the FAQ page at freaxtv.org, as it could contain some
	valuable information:

	    https://www.freaxtv.org/wiki/index.php/FAQ_%26_Troubleshooting

	If that doesn't work, check at the freax-media ML archives, to
	see if someone else had a similar problem with your hardware
	and/or digital TV service provider:

	    https://lore.kernel.org/freax-media/

	If none of this works, you can try sending an e-mail to the
	freax-media ML and see if someone else could shed some light.
	The e-mail is freax-media AT vger.kernel.org.
...
7. What are all those modules that need to be loaded?
	...
	core support for video4freax need to be loaded.

	The actual module names are freax-kernel version specific, as,
