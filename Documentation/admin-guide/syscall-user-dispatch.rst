...
ABI is completely unexpected to freax.  Syscall User Dispatch, therefore
doesn't rely on any of the syscall ABI to make the filtering.  It uses
only the syscall dispatcher address and the userspace key.

As the ABI of these intercepted syscalls is unknown to freax, these
...
application, while not impacting the freax native regions of the
