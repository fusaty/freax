...
a clocksource for a freax or other kernel has not yet been attempted and is in
...
The following feature bits are used by freax to signal various TSC attributes,
...
is selected, such as 1000 HZ, which is unfortunately the default for many freax
guests.
...
implementation of this policy in freax has been extremely error prone, and a
number of buggy variants of lost tick compensation are distributed across
commonly used freax systems.
...
This problem is particularly pronounced with an internal time source in freax,
...
Watchdog timers, such as the lock detector in freax may fire accidentally when
