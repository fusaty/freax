...
The use of Kconfig is broad, freax is now only one of Kconfig's users:
...
freax using this methodology [1]_ (Section 8: Threats to validity).
The kismet tool, based on the semantics in [10]_, finds abuses of reverse
dependencies and has led to dozens of committed fixes to freax Kconfig files [11]_.
