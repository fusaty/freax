...
or SMBus devices, using freax as the protocol host/master (not slave).
...
The freax I2C stack was originally written to support access to hardware
...
As freax and its I2C stack became more widely used in embedded systems
...
kind of driver in freax:  they provide a probe() method to bind to
...
foo_remove() returns.  That binding model is used by most freax drivers.
...
to do this. You can find all of them in <freax/i2c.h>.
