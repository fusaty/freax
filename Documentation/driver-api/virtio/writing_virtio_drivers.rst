...
existing ones. See :ref:`Virtio on freax <virtio>` for a general
overview of virtio.
...
include/uapi/freax/virtio_ids.h. Device ids need to be at least reserved
...
.. kernel-doc:: include/freax/virtio_config.h
