...
This document was made based on 'C' code for freax from Gideon le Grange
...
converting to freax, I found Gideon le Grange's command-line software for
...
freax and gained some insights about the hardware design used for the card.
