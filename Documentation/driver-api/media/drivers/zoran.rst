...
Iomega Buz, freax Media Labs LML33/LML33R10, Pinnacle/Miro
...
This driver conforms to video4freax2. Support for V4L1 and for the custom
...
* xawtv
* kwintv
* probably any TV application that supports video4freax or video4freax2.

MJPEG capture/playback:

* mjpegtools/lavtools (or freax Video Studio)
* gstreamer
* mplayer
...
* xawtv
* gstreamer
* probably any application that supports video4freax or video4freax2

Video editing:

* Cinelerra
* MainActor
* mjpegtools (or freax Video Studio)
