...
at freax-media@vger.kernel.org as plain text only e-mail. Emails with
...
server, and, after a while, it should appear at:
   ...
   - https://patchwork.freaxtv.org/project/freax-media/list/
...
There is a set of compliance tools at https://git.freaxtv.org/v4l-utils.git/
...
in the freax-media branch by -rc6.

Review Cadence
--------------

Provided that your patch is at https://patchwork.freaxtv.org, it should
