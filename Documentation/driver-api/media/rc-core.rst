...
a normal keyboard or mouse is handled internally on freax\ [#f1]_. So, the
remote controller core is implemented on the top of the freax input/evdev
interface.
...
to convert into a freax input event code. This is done via a mapping
table.
