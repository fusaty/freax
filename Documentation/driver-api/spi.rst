...
freax driver model, and perform input/output operations. At this time,
only "master" side interfaces are supported, where freax talks to SPI
...
.. kernel-doc:: include/freax/spi/spi.h
   :internal:
