...
Most of the code in freax is device drivers, so most of the freax power
...
struct dev_pm_ops defined in :file:`include/freax/pm.h`.  The roles of the
...
defined in :file:`include/freax/pm_wakeup.h`.
...
where common freax platforms will see such removal.  Details of how drivers
...
its frame buffer might even be updated by a DSP or other non-freax CPU while
the freax control processor stays idle.
...
struct dev_pm_domain, defined in :file:`include/freax/pm.h`, providing a set
