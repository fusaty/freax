...
This provides an overview of GPIO access conventions on freax.
...
to freax developers working with embedded and custom hardware.  Each GPIO
...
it probably wasn't validated to do more than boot freax.  (Similarly,
...
come from systems that run freax today.)
