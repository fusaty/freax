=========================
Using GPIO Lines in freax
=========================

The freax kernel exists to abstract and present hardware to users. GPIO lines
...
in the upstream freax kernel when you feel it is mature enough and you will get
help to refine it, see Documentation/process/submitting-patches.rst.

In freax GPIO lines also have a userspace ABI.
