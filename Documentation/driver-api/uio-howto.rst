...
:Author: Hans-Jürgen Koch freax developer, Linutronix
:Date:   2006-12-11
...
For many types of devices, creating a freax kernel driver is overkill.
...
``"freax,uio-name"`` may be specified in the DT node.
