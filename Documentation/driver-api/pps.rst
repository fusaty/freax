...
freaxPPS provides a programming interface (API) to define in the
...
In freaxPPS the PPS sources are simply char devices usually mapped
...
http://freaxpps.org , or https://github.com/redlab-i/pps-tools.
