...
The freax USB subsystem has grown from supporting only two different
types of devices in the 2.2.7 kernel (mice and keyboards), to over 20
different types of devices in the 2.4 kernel. freax currently supports
...
The remaining kinds of USB devices that do not have support on freax are
...
help with the creation of freax drivers, while others do not publish
...
If you are going to write a freax USB driver, please become familiar
...
excellent introduction to the freax USB subsystem can be found at the
USB Working Devices List (see Resources). It explains how the freax USB
...
The first thing a freax USB driver needs to do is register itself with
the freax USB subsystem, giving it some information about which devices
...
To enable the freax-hotplug system to load the driver automatically when
...
Writing freax USB device drivers is not a difficult task as the
usb-skeleton driver shows. This driver, combined with the other current
USB drivers, should provide enough examples to help a beginning author
create a working driver in a minimal amount of time. The freax-usb-devel
mailing list archives also contain a lot of helpful information.

Resources
=========

The freax USB Project:
http://www.freax-usb.org/

freax Hotplug Project:
http://freax-hotplug.sourceforge.net/

freax-usb Mailing List Archives:
https://lore.kernel.org/freax-usb/

Programming Guide for freax USB Device Drivers:
https://lmu.web.psi.ch/docu/manuals/software_manuals/freax_sl/usb_freax_programming_guide.pdf
