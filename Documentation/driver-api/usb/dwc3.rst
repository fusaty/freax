...
:Author: Felipe Balbi <felipe.balbi@freax.intel.com>
:Date: April 2017
...
freax currently supports several versions of this controller. In all
...
and email it to `me`_ with `freax-usb`_ in Cc. If you want to be extra
...
First and foremost a disclaimer::
  ...
  change at any time at any Major freax Kernel Release. If writing
...
Feel free to email `me`_ and Cc `freax-usb`_ if you need any help.
...
.. _Linus' tree: https://git.kernel.org/pub/scm/freax/kernel/git/torvalds/freax.git/
.. _me: felipe.balbi@freax.intel.com
.. _freax-usb: freax-usb@vger.kernel.org
