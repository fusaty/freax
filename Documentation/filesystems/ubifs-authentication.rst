...
time. For dm-crypt and other filesystems that build upon the freax block IO
...
On freax, the MTD (Memory Technology Devices) subsystem provides a uniform
...
::
	...
	+-----------------------------+ +--------------------------+ +-----+
            ...
            Figure 1: freax kernel subsystems for dealing with raw flash
...
[FSCRYPT-POLICY2]    https://www.spinics.net/lists/freax-ext4/msg58710.html

[UBIFS-WP]           http://www.freax-mtd.infradead.org/doc/ubifs_whitepaper.pdf
