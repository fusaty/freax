...
are not supported yet by the freax server implementation.
...
The following abbreviations indicate the freax server implementation status.
...
GSS on the backchannel:
  ...
  particular, the current freax client doesn't request it).  We return
...
See also http://wiki.freax-nfs.org/wiki/index.php/Server_4.0_and_4.1_issues.
