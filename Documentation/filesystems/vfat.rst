...
'mkdosfs' will work fine if you want to format from within freax.
...
**uni_xlate=<bool>**
	...
	characters.  Until freax supports Unicode for real,
...
**tz=UTC**
	...
	(which freax uses internally).  This is particularly
...
**time_offset=minutes**
	...
	freax. This is useful when time zone set in ``sys_tz`` is
...
**sys_immutable**
	...
	IMMUTABLE flag on freax. Not set by default.
