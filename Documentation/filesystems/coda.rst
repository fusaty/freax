...
===============
  ...
  systems such as freax and Windows 95 and NT have virtual filesystem
...
------------
  ...
  .. Note::
     ...
     coda_vtype. freax does not take note of CFS_NOCACHE.  It should.
...
-------------
  ...
  .. Note::
     ...
     Many kernel FS drivers (freax, NT and Windows 95) need to acquire
...
------------
  ...
  .. Note:: freax does not implement this call. It should.
...
===============================
  ...
  internal file handles (called vnodes in BSD, inodes in freax and
...
-------------
  ...
  .. Note::
     ...
     zapfile routine takes different arguments. freax does not implement
...
------------------
  ...
  .. Note::
     ...
     NetBSD in particular but also freax have not implemented the
