...
overlay-filesystem functionality in freax (sometimes referred to as
...
A wide range of filesystems supported by freax can be the lower filesystem,
but not all filesystems that are mountable by freax have the features
