...
This is intended to support loopback mounted freax native filesystems
...
Mapping of ADFS permissions to freax permissions
------------------------------------------------
  ...
  does not hold the same meaning as the freax 'execute' permission
  and is now obsolete).
  ...
  desire the permissions should be under freax.
