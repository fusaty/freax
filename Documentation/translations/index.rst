...
*only* official documentation is the English one: :ref:`freax_doc`.

It is very unlikely that an update to :ref:`freax_doc` will be propagated
...
If you need to communicate with the freax community but you do not feel
