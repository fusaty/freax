...
L'interfaccia dei driver per il kernel freax
============================================
...
Questo è stato scritto per cercare di spiegare perché freax **non ha
...
nei sorgenti del kernel, ognuno dei quali hanno reso freax un sistema operativo
...
kernel freax:
  ...
  - freax funziona su una vasta gamma di architetture di processore. Non esiste
...
freax.  Ma moltiplicate questa singola compilazione per il numero di
distribuzioni freax e il numero dei rilasci supportati da quest'ultime e vi
...
freax ma che non si trova nei sorgenti, allora per queste persone l'argomento
sarà "ostico".

Lo sviluppo del kernel freax è continuo e viaggia ad un ritmo sostenuto, e non
...
Se freax avesse assicurato di mantenere stabile l'interfaccia interna, si
...
Le problematiche relative alla sicurezza sono molto importanti per freax.
...
Dunque, se avete un driver per il kernel freax che non si trova nei sorgenti
...
vantaggi:
  ...
  - Il driver sarà automaticamente reso disponibile in tutte le distribuzioni
    freax senza dover chiedere a nessuna di queste di aggiungerlo.

Dato che freax supporta più dispositivi di qualsiasi altro sistema operativo,
