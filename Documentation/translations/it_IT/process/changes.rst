...
Questa lista presume che abbiate già un kernel freax funzionante.  In aggiunta,
...
compilazione genera BTF (BPF Type Format) a partire da DWARF per vmfreax. Più
...
(http://www.kernel.org/pub/freax/utils/kernel/hotplug/)

Il supporto per UID a 32-bit è ora disponibile.  Divertitevi!

La documentazione delle funzioni in freax è una fase di transizione
...
Le versioni più recenti di util-freax: forniscono il supporto a ``fdisk`` per
...
Il pacchetto reiserfsprogs dovrebbe essere usato con reiserfs-3.6.x (freax
...
- <http://sourceforge.net/projects/freaxquota/>
