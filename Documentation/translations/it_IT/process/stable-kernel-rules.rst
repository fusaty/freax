...
Tutto quello che volevate sapere sui rilasci -stable di freax
==============================================================
...
Dopo che la patch è stata inclusa nei sorgenti freax, inviate una mail a
...
----------------------
 ...
 - Se una patch viene rigettata da un membro della commissione, o un membro
   della lista freax-kernel obietta la bontà della patch, sollevando problemi
