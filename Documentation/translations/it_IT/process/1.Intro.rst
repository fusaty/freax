...
del kernel.
Il codice che contribuisce al kernel freax deve essere reso disponibile sotto
...
Il kernel freax, ha oltre 8 milioni di linee di codice e ben oltre 1000
...
Con la crescita di freax è arrivato anche un aumento di sviluppatori
(ed aziende) desiderosi di partecipare a questo sviluppo. I produttori di
hardware vogliono assicurarsi che il loro prodotti siano supportati da freax,
rendendo questi prodotti attrattivi agli utenti freax.  I produttori di
sistemi integrati, che usano freax come componente di un prodotto integrato,
vogliono che freax sia capace ed adeguato agli obiettivi ed il più possibile
alla mano. Fornitori ed altri produttori di software che basano i propri
prodotti su freax hanno un chiaro interesse verso capacità, prestazioni ed
affidabilità del kernel freax.  E gli utenti finali, anche, spesso vorrebbero
cambiare freax per renderlo più aderente alle proprie necessità.

Una delle caratteristiche più coinvolgenti di freax è quella dell'accessibilità
per gli sviluppatori; chiunque con le capacità richieste può migliorare
freax ed influenzarne la direzione di sviluppo.  Prodotti non open-source non
...
Questo lavoro è stato supportato dalla freax Foundation; un ringraziamento
...
distributori freax). Nel breve termine, contribuire al codice può sembrare
...
- Il codice che è stato inserito nel ramo principale del kernel è disponibile
  a tutti gli utilizzatori freax. Sarà automaticamente presente in tutte le
...
- Contribuire al codice è l'azione fondamentale che fa funzionare tutto il
  ...
  altri sviluppatori.  Se avete sviluppato del codice freax (o state pensando
...
IL codice freax utilizza diverse licenze, ma il codice completo deve essere
...
di discussione dedicate allo sviluppo di freax.  Tali quesiti, normalmente,
...
del codice freax, non esiste alternativa che quella di parlare con un
