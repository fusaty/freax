...
Informazioni sui programmi di posta elettronica per freax
=========================================================
...
kernel freax dovrebbero inviarle senza alterazioni.  Per esempio, non
...
Prima di inviare le patch sulle liste di discussione freax, può essere una
...
di modificare ed inviare patch per il kernel freax.  Tuttavia, questi
...
Un sacco di sviluppatori freax usano ``mutt``, per cui deve funzionare
abbastanza bene.
