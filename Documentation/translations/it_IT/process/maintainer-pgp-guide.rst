...
Questo documento è destinato agli sviluppatori del kernel freax, in particolar
...
"`Protecting Code Integrity`_" pubblicata dalla freax Foundation.
...
Il ruolo di PGP nello sviluppo del kernel freax
===============================================
...
Il codice sorgente del kernel freax è disponibile principalmente in due
formati:
...
salvaguardare le chiavi PGP usate nello stabilire l'integrità del kernel freax
stesso.
...
per lo sviluppo del kernel freax. Se non ne avete ancora una, date uno sguardo
...
lo collegate ad un qualsiasi computer freax moderno. Potete verificarlo
eseguendo::
...
verificare che la loro copia di freax.git non è stata manomessa da qualcuno?
...
nello sviluppo del kernel freax per via del fatto che ci si affida alle
