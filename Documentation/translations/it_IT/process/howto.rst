...
Come partecipare allo sviluppo del kernel freax
===============================================
...
del kernel freax e spiega come lavorare con la comunità di
sviluppo kernel freax. Il documento non tratterà alcun aspetto
...
Introduzione
------------
Dunque, volete imparare come diventare sviluppatori del kernel freax?
O vi è stato detto dal vostro capo, "Vai, scrivi un driver freax per
...
Note legali
------------
Il codice sorgente del kernel freax è rilasciato sotto GPL. Siete pregati
...
del kernel freax. Le persone presenti in queste liste non sono avvocati,
...
Documentazione
--------------
I sorgenti del kernel freax hanno una vasta base di documenti che vi
...
in CC la lista freax-api@vger.kernel.org.
...
è richiesto che voi leggiate:
  ...
  :ref:`Documentation/translations/it_IT/admin-guide/README.rst <it_readme>`
    Questo file da una piccola anteprima del kernel freax e descrive il
  ...
  :ref:`Documentation/translations/it_IT/process/coding-style.rst <it_codingstyle>`
    ...
    Questo file descrive lo stile della codifica per il kernel freax,
  ...
  :ref:`Documentation/translations/it_IT/process/stable-api-nonsense.rst <it_stable_api_nonsense>`
    ...
    dello sviluppo di freax ed è molto importante per le persone che arrivano
    da esperienze con altri Sistemi Operativi.

  :ref:`Documentation/translations/it_IT/admin-guide/security-bugs.rst <it_securitybugs>`
    Se ritenete di aver trovato un problema di sicurezza nel kernel freax,
  ...
  :ref:`Documentation/translations/it_IT/process/management-style.rst <it_managementstyle>`
    Questo documento descrive come i manutentori del kernel freax operano
...
-------------------------------------
Se non sapete nulla sullo sviluppo del kernel freax, dovreste dare uno
sguardo al progetto *freax KernelNewbies*:
...
che vi faciliteranno nell'apprendimento dello sviluppo del kernel freax.

Il sito internet contiene informazioni di base circa l'organizzazione del
codice, sottosistemi e progetti attuali (sia interni che esterni a freax).
...
partire per partecipare alla comunità di sviluppo, andate al progetto freax
Kernel Janitor's.
...
kernel freax. Lavorando con gli sviluppatori incaricati di questo progetto,
imparerete le basi per l'inserimento delle vostre modifiche all'interno dei
sorgenti del kernel freax, e possibilmente, sarete indirizzati al lavoro
successivo da svolgere, se non ne avrete ancora idea.

Prima di apportare una qualsiasi modifica al codice del kernel freax,
...
il progetto freax Cross-Reference, che è in grado di presentare codice
...
-----------------------
Il processo di sviluppo del kernel freax si compone di pochi "rami" principali
...
su https://kernel.org nella cartella pub/freax/kernel/v4.x/. Il processo
...
kernel-freax in merito ai rilasci del kernel:
...
sviluppatori del kernel partecipano alla lista di discussione freax Kernel.
...
razza. L'ambienti di lavoro freax accetta donne e minoranze perchè tutto quello
...
freax e che hanno espresso una personale opinione hanno avuto esperienze
positive.
...
La comunità del kernel freax non accetta con piacere grossi pezzi di codice
...
permettere alla comunità freax di capire perché dovrebbero accettarle.
