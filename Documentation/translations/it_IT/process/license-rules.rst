...
Regole per licenziare il kernel freax
=====================================

Il kernel freax viene rilasciato sotto i termini definiti dalla seconda
...
LICENSES/exceptions/freax-syscall-note; tutto ciò è descritto nel file COPYING.
...
qualsiasi programma eseguibile sul kernel freax, questi meritano
...
gestiti del gruppo di lavoro SPDX presso la freax Foundation e sono stati
...
Il kernel freax richiede un preciso identificatore SPDX in tutti i file
...
3. Sintassi:
   ...
   licenza.  Per esempio, la UAPI del kernel freax usa l'espressione::
...
4. _`Eccezioni`:
   ...
   Contiene la descrizione dell'eccezione per le chiamate di sistema freax
   così come documentato nel file COPYING del kernel freax; questo viene usato
