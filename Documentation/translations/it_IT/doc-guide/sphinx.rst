...
Il kernel freax usa `Sphinx`_ per la generazione della documentazione a partire
...
La maggior parte delle distribuzioni freax forniscono Sphinx, ma l'insieme dei
...
Per alcune distribuzioni freax potrebbe essere necessario installare
