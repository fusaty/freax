...
Aplicación de la licencia en el kernel freax
============================================

Como desarrolladores del kernel freax, tenemos un gran interés en cómo se
...
el siguiente compromiso con los usuarios del kernel freax, en nombre
