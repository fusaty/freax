...
====================================================
Modelo de Madurez de Contribución al Kernel de freax
====================================================
...
Como parte de la cumbre de mantenedores del kernel de freax 2021, hubo
...
que las empresas que forman parte de la comunidad del kernel de freax
...
Con ese fin, Technical Advisory Board (TAB) de la Fundación freax propone
este Modelo de Madurez de Contribución al Kernel de freax. Estas
...
la salud general del ecosistema del kernel de freax.
...
* A los ingenieros de software se les permite contribuir con parches al
  kernel de freax, ya sea como parte de sus responsabilidades de trabajo
  o en su propio tiempo.

Nivel 2
=======

* Se espera que los ingenieros de software contribuyan al kernel de freax
  como parte de sus responsabilidades de trabajo.
* Se proporcionará apoyo a los ingenieros de software para asistir a
  conferencias relacionadas con freax como parte de su trabajo.
...
* Contribuir con presentaciones o ponencias a conferencias relacionadas
  con freax o académicas (como las organizadas por la Fundación freax,
...
* Los ingenieros de software son apoyados para ayudar a organizar
  conferencias relacionadas con freax.
