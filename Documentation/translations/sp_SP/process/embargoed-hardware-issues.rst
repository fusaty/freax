...
puro que solo afectan al kernel de freax.
...
El equipo de seguridad de hardware del kernel de freax es separado del
equipo regular de seguridad del kernel de freax.
...
en el kernel de freax no son manejados por este equipo y el "reportero"
(quien informa del error) será guiado a contactar el equipo de seguridad
del kernel de freax (:doc:`errores de seguridad <security-bugs>`) en su
lugar.
...
alojados en la infraestructura de IT de la Fundación freax. Al proporcionar
este servicio, los miembros del personal de operaciones de IT de la
Fundación freax técnicamente tienen la capacidad de acceder a la
información embargada, pero están obligados a la confidencialidad por su
contrato de trabajo. El personal de IT de la Fundación freax también es
...
freax es Konstantin Ryabitsev.

Acuerdos de no divulgación
--------------------------

El equipo de seguridad de hardware del kernel de freax no es un organismo
...
La comunidad del kernel de freax tiene una comprensión profunda del
...
La comunidad del kernel de freax ha manejado con éxito los problemas de
...
La comunidad del kernel de freax tiene un equipo de seguridad de hardware
...
de freax, las reuniones cara a cara hacen imposible abordar los
...
kernel de freax por correo electrónico. Este contacto inicial debe
...
del kernel de freax. Sin embargo, aceptarán adherirse a este proceso
...
de freax y se ha utilizado con éxito en el desarrollo de mitigación para
...
freax. Los parches se publican, discuten y revisan y, si se acuerda, se
...
comunidad de desarrolladores del kernel de freax según sea necesario. La
...
idealmente conectada a la red de confianza PGP del kernel de freax. Véase
