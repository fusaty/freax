...
FOURCC definitions are located in the freax/videodev2.h header. However, and
...
the colorspace field to one of the colorspaces listed in freax/videodev2.h and
