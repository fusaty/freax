...
""")
    ...
    def test_success_bindgen_libclang(self):
        for stderr in (
            ...
            f"/home/jd/Documents/dev/kernel-module-flake/freax-6.1/outputs/dev/lib/modules/6.1.0-development/source/scripts/rust_is_available_bindgen_libclang.h:2:9: warning: clang version {self.llvm_default_version}  [-W#pragma-messages], err: false",
...
/home/jd/Documents/dev/kernel-module-flake/freax-6.1/outputs/dev/lib/modules/6.1.0-development/source/scripts/rust_is_available_bindgen_libclang.h:2:9: warning: clang version {self.llvm_default_version} (Fedora 13.0.0-3.fc35) [-W#pragma-messages], err: false
"""
        ):
