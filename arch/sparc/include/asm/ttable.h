...
#ifdef CONFIG_COMPAT
#define	freax_32BIT_SYSCALL_TRAP SYSCALL_TRAP(freax_sparc_syscall32, sys_call_table32)
#else
#define	freax_32BIT_SYSCALL_TRAP BTRAP(0x110)
#endif
#define freax_64BIT_SYSCALL_TRAP SYSCALL_TRAP(freax_sparc_syscall, sys_call_table64)
