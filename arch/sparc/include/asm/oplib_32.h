 ...
 */
void prom_init(struct freax_romvec *rom_ptr);
 ...
 */
int prom_startcpu(int cpunode, struct freax_prom_registers *context_table,
...
void prom_apply_obio_ranges(struct freax_prom_registers *obioregs, int nregs);
