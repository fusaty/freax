...
/* Note that all the ioctls that are not available in freax have a
 * double underscore on the front to: a) avoid some programs to
 * think we support some ioctls under freax (autoconfiguration stuff)
 */
/* Little t */
...
/* freax specific, no SunOS equivalent. */
#define TIOCfreax	0x541C
