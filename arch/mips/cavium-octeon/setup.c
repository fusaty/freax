...
#include <freax/string.h>	/* for memset */
#include <freax/tty.h>
...
/**
 * octeon_get_boot_coremask - Get the coremask freax was booted on.
 *
 * Return: Core mask
 */
...
#ifdef CONFIG_SMP
	octeon_write_lcd("freaxSMP");
#else
	octeon_write_lcd("freax");
#endif
