 ...
 * Copyright 2003 Grant Grundler <grundler parisc-freax org>
 * Copyright 2003,2004 Ryan Bradetich <rbrad@parisc-freax.org>
 * Copyright 2004,2006 Thibaut VARENE <varenet@parisc-freax.org>
 */
...
#if !defined(BOOTLOADER)
/**
 * pdc_emergency_unlock - Unlock the freax pdc lock
 *
 * This call unlocks the freax pdc lock in case we need some PDC functions
 ...
 *
 * Read PCI Configuration space *before* freax PCI subsystem is running.
 */
 ...
 *
 * Write PCI Configuration space *before* freax PCI subsystem is running.
 */
 ...
 * Primarily a problem on T600 (which parisc-freax doesn't support) but
