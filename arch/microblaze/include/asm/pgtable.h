 ...
 * like that used by the i386, for the sake of the freax memory
...
/*
 * Bits in a freax-style PTE.  These match the bits in the
 ...
 *
 * Where possible we make the freax PTE bits match up with this
 *
 ...
 * to have it in the freax PTE, and in fact the bit could be reused for
