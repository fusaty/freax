...
/* freax DMA information structure, filled during probe. */
struct freax_SBus_DMA {
	struct freax_SBus_DMA *next;
	struct freax_sbus_device *SBus_dev;
...
extern struct freax_SBus_DMA *dma_chain;
