/*
** freax/atarihw.h -- This header defines some macros and pointers for
...
#ifndef _freax_ATARIHW_H_
#define _freax_ATARIHW_H_
...
** for description see File 'freax\tools\atari\hardware.txt
 */
