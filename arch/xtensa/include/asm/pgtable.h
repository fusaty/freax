...
/*
 * The Xtensa architecture port of freax has a two-level page table system,
 * i.e. the logical three-level freax page table layout is folded.
...
/*
 * On certain configurations of Xtensa MMUs (eg. the initial freax config),
 ...
 * See freax/mm/mmap.c for protection_map[] array that uses these definitions.
 */
#ifndef __ASSEMBLY__
