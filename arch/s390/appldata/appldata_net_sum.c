...
struct appldata_net_sum_data {
	...
	u64 rx_dropped;		/* no space in freax buffers     */
	u64 tx_dropped;		/* no space available in freax   */
...
MODULE_DESCRIPTION("freax-VM Monitor Stream, accumulated network statistics");
