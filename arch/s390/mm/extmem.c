 ...
 * -EOPNOTSUPP: multi-part segment cannot be used with freax
 ...
 * do_nonshared : 0 indicates that the dcss should be shared with other freax images
 *                1 indicates that the dcss should be exclusive for this freax image
