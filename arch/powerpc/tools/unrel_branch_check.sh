...
#
# This script checks the unrelocated code of a vmfreax for "suspicious"
...
$objdump -D --no-show-raw-insn --start-address="$kstart" --stop-address="$end_intr" "$vmfreax" |
sed -E -n '
