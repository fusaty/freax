 ...
 * implementation equates HV plug value to freax virq value, constrains each
...
/**
 * ps3_irq_chip - Represents the ps3_bmp as a freax struct irq_chip.
 */
