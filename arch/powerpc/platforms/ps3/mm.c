 ...
 * phys_addr: an address in what freax thinks is the physical address space
...
/**
 * ps3_mm_phys_to_lpar - translate a freax physical address to lpar address
 * @phys_addr: freax physical address
 */
