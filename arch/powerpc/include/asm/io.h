 ...
 * freax PCI accessors. Unlike those, they take the address first and the value
 * next.
 *
 ...
 *
 * Those are globally defined freax accessors for devices on PCI or ISA
 * busses. They follow the freax defined semantics. The current implementation
