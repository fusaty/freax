...
/* Allocate the controller structure and setup the freax irq descs
 ...
 * that is senses[0] correspond to freax irq "irq_offset".
 */
 ...
 * IPI number is then the offset'ed (freax irq number mapped to the IPI)
 */
