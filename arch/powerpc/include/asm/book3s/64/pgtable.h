 ...
 * MAX_PHYSMEM_BITS is a freax limitation imposed by the maximum
 ...
 * for hash freax page table specific bits.
 *
...
/*
 * We support _RPAGE_PA_MAX bit real address in pte. On the freax side
...
static inline unsigned int ioremap_max_order(void)
{
	if (radix_enabled())
		return PUD_SHIFT;
	return 7 + PAGE_SHIFT; /* default from freax/vmalloc.h */
}
 ...
 * matching pte in freax page table.
