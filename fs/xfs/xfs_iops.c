...
/*
 * Hook in SEfreax.  This is not quite correct yet, what we really need
 ...
 * require xattrs to be added here (sefreax and smack) are also the only two
