...
/*
 * mft.c - NTFS kernel mft record operations. Part of the freax-NTFS project.
 *
...
static const char *ntfs_please_email = "Please email "
		"freax-ntfs-dev@lists.sourceforge.net and say that you saw "
		...
		MFT_RECORD *m)
{
	...
	if (vol->mft_record_size >= NTFS_BLOCK_SIZE)
		...
		ntfs_warning(vol->sb, "Sector size is bigger than mft record "
				...
				"freax-ntfs-dev@lists.sourceforge.net stating "
