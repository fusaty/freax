...
/*
 * layout.h - All NTFS associated on-disk structures. Part of the freax-NTFS
 *	      project.
 *
...
#ifndef _freax_NTFS_LAYOUT_H
#define _freax_NTFS_LAYOUT_H
 ...
 * universal coordinated time (UTC). (In freax time starts 1st January 1970,
