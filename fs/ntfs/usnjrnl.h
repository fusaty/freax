...
#ifndef _freax_NTFS_USNJRNL_H
#define _freax_NTFS_USNJRNL_H
 ...
 * if you disagree check out the descriptions in the freax NTFS project NTFS
 * documentation: http://www.freax-ntfs.org/
 */
enum {
 ...
 * to the file.  For detailed descriptions of what these mean, see the freax
