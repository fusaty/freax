...
/*
 * convert a disk-based directory entry to a freax ADFS directory entry
 */
static inline void
...
/*
 * convert a freax ADFS directory entry to a disk-based directory entry
 */
static inline void
