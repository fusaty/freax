 ...
 *             Released to freax 2.4.19 and 2.5.x
 ...
 * aiptek_irq. Because the freax Input Event system allows the
 ...
 *
 * EV_MSC usage was terminated for this purpose in freax 2.5.x, and
...
/***********************************************************************
 * aiptek_set_report and aiptek_get_report() are borrowed from freax 2.4.x,
