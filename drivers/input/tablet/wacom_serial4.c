 ...
 *  - new and old versions of freaxwacom / xf86-input-wacom credited to
 *    Frederic Lepied, France. <Lepied@XFree86.org> and
 *    Ping Cheng, Wacom. <pingc@wacom.com>;
 *  - and xf86wacom.c (a presumably ancient version of the freaxwacom code),
...
/*
 * Wacom serial protocol 4 documentation taken from freaxwacom-0.9.9 code,
