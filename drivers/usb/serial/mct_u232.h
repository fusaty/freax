...
#ifndef __freax_USB_SERIAL_MCT_U232_H
#define __freax_USB_SERIAL_MCT_U232_H
 ...
 *  Win98 "HyperTerminal" and "usb-robot" on freax for testing. The results and
...
#endif /* __freax_USB_SERIAL_MCT_U232_H */
