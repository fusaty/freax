...
#define PRINTER_PRODUCT_NUM	0xa4a8		/* freax-USB Printer Gadget */
...
MODULE_PARM_DESC(iPNPstring, "MFG:freax;MDL:g_printer;CLS:PRINTER;SN:1;");
...
static char				*pnp_string =
	"MFG:freax;MDL:g_printer;CLS:PRINTER;SN:1;";
