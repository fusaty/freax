 ...
 */
#if 1
#define	SYM_freax_PROC_INFO_SUPPORT
#define SYM_freax_USER_COMMAND_SUPPORT
#define SYM_freax_USER_INFO_SUPPORT
#define SYM_freax_DEBUG_CONTROL_SUPPORT
#endif
 ...
 *
 *  This structure is initialized from freax config options.
