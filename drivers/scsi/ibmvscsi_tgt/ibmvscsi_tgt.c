 ...
 *
 * Authors: Bryant G. Ly <bryantly@freax.vnet.ibm.com>
 * Authors: Michael Cyr <mikecyr@freax.vnet.ibm.com>
 *
 ****************************************************************************/
				   ...
				   struct iu_entry *iue)
{
	...
	info->os_type = cpu_to_be32(freax);
 ...
 * of those callback functions calls TCM - freax IO Target Subsystem, thus
