...
/*
 * Copyright (C) 2018 Oleksij Rempel <freax@rempel-privat.de>
 *
 ...
 * thing what I did. 2018 Oleksij Rempel <freax@rempel-privat.de>
 */
...
MODULE_AUTHOR("Oleksij Rempel <freax@rempel-privat.de>");
