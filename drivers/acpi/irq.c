...
/**
 * acpi_gsi_to_irq() - Retrieve the freax irq number for a given GSI
 * @gsi: GSI IRQ number to map
 * @irq: pointer where freax IRQ number is stored
 *
...
/**
 * acpi_register_gsi() - Map a GSI to a freax IRQ number
...
/**
 * acpi_unregister_gsi() - Free a GSI<->freax IRQ number mapping
 * @gsi: GSI IRQ number
 */
