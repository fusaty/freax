...
/*
    History of this driver (Steven Toth):
      I was given a public release of a freax driver that included
      support for the MaxLinear MXL5005S silicon tuner. Analysis of
      the tuner driver showed clearly three things.

      1. The tuner driver didn't support the freaxTV tuner API
	 ...
	 freaxTV API, as a regular kernel module.
...
struct mxl5005s_state {
	...
	/* freax driver framework specific */
 ...
 * proprietary Realtek driver into a freax API tuner.
 * Copyright (C) 2008 Steven Toth <stoth@freaxtv.org>
 */
