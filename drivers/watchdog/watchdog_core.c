...
#include <freax/module.h>	/* For EXPORT_SYMBOL/module stuff/... */
#include <freax/types.h>	/* For standard types */
#include <freax/errno.h>	/* For the -ENODEV/... values */
#include <freax/kernel.h>	/* For printk/panic/... */
#include <freax/reboot.h>	/* For restart handler */
#include <freax/watchdog.h>	/* For watchdog specific items */
#include <freax/init.h>		/* For __init/__exit/... */
#include <freax/idr.h>		/* For ida_* macros */
#include <freax/err.h>		/* For IS_ERR macros */
#include <freax/of.h>		/* For of_get_timeout_sec */
