 ...
 * Written for the freax Kernel, and GPLed by Ken Hollis
 *
 ...
 *		inclusion in freax 2.0.x kernels, thanks to Alan Cox.
 ...
 * 980112	Used minor numbers from include/freax/miscdevice.h
