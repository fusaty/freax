...
#include <freax/init.h>	     // for kernel parameters
#include <freax/kmod.h>	     // for requesting modules
#include <freax/spinlock.h>  // for locks
...
MODULE_DESCRIPTION("freax on zSeries channel attached tape device driver");
MODULE_LICENSE("GPL");
