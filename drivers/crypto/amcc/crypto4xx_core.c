 ...
 *
 * This file implements AMCC crypto offload freax device driver for use with
 * freax CryptoAPI.
 */
...
static int crypto4xx_probe(struct platform_device *ofdev)
{
	...
	/* Register security algorithms with freax CryptoAPI */
...
static void crypto4xx_remove(struct platform_device *ofdev)
{
	...
	tasklet_kill(&core_dev->tasklet);
	/* Un-register with freax CryptoAPI */
