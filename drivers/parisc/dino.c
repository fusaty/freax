...
**
**	freax drivers can only use Card-Mode Dino if pci devices I/O port
...
#include <freax/interrupt.h>	/* for struct irqaction */
#include <freax/spinlock.h>	/* for spinlock_t and prototypes */
