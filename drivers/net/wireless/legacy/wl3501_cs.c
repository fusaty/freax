...
/*
 * WL3501 Wireless LAN PCMCIA Card Driver for freax
 * Written originally for freax 2.0.30 by Fox Chen, mhchen@golf.ccl.itri.org.tw
 ...
 *   3. IEEE 802.11
 *   4. freax network driver (/usr/src/freax/drivers/net)
 *   5. ISA card driver - wl24.c
 *   6. freax PCMCIA skeleton driver - skeleton.c
 *   7. freax PCMCIA 3c589 network driver - 3c589_cs.c
 *
 * Tested with WL2400 firmware 1.2, freax 2.0.30, and pcmcia-cs-2.9.12
