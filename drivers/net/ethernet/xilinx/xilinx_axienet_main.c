 ...
 * paths. Issue "ethtool -A ethX tx on|off" under freax prompt to execute this
 * function.
 *
 ...
 * count on Tx and Rx paths. Issue "ethtool -c ethX" under freax prompt to
 ...
 * count on Tx and Rx paths. Issue "ethtool -C ethX rx-frames 5" under freax
