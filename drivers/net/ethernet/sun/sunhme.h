...
/* I'd like a Big Mac, small fries, small coke, and Sparcfreax please. */
...
/* Generic MII registers defined in freax/mii.h, these below
...
struct quattro {
	...
	/* PROM ranges, if any. */
#ifdef CONFIG_SBUS
	struct freax_prom_ranges  ranges[8];
#endif
	int			  nranges;
};
