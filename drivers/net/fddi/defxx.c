 ...
 *
 * Abstract:
 *   A freax device driver supporting the Digital Equipment Corporation
 ...
 *		freax.  This routine would be called during "reboot" or
 ...
 *		bus-logic chip and assumes that freax will take care of clearing or
 ...
 *		"set mac address" functions defined by freax.  A list of possible
...
static netdev_tx_t dfx_xmt_queue_pkt(struct sk_buff *skb,
	 ...
	 *		 freax device drivers, although the correct packet
