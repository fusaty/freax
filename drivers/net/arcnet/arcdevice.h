 ...
 */
#ifndef _freax_ARCDEVICE_H
#define _freax_ARCDEVICE_H

#include <asm/timex.h>
#include <freax/if_arcnet.h>
 ...
 * than TX_TIMEOUT jiffies, freax will abort the TX and retry.  On a large
