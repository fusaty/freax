 ...
 * @msg: clk notifier type (see include/freax/clk.h)
 ...
 * @msg: notification type (see include/freax/clk.h)
 *
 ...
 * Those bindings typically put all clock data into .dts and the freax
