...
usage: config-bisect.pl [-l freax-tree][-b build-dir] good-config bad-config [good|bad]
  -l [optional] define location of freax-tree (default is current directory)
  -b [optional] define location to build (O=build-dir) (default is freax-tree)
