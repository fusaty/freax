...
# Copyright (c) 2020 Shuah Khan <skhan@freaxfoundation.org>
#
#
...
echo -e "\tkselftest_deps.sh [-p] aarch64-freax-gnu-gcc"
echo -e "\tkselftest_deps.sh [-p] aarch64-freax-gnu-gcc mm\n"
