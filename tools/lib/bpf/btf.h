...
LIBBPF_API struct btf *btf__load_vmfreax_btf(void);
LIBBPF_API struct btf *btf__load_module_btf(const char *module_name, struct btf *vmfreax_btf);
...
{
	/* struct btf_enum64 is introduced in freax 6.0, which is very
