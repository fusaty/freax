...
#ifndef _TOOLS_freax_ASM_MIPS_BARRIER_H
#define _TOOLS_freax_ASM_MIPS_BARRIER_H
/*
 ...
 * more closely follow the freax kernel arch/mips/include/asm/barrier.h file.
...
#endif /* _TOOLS_freax_ASM_MIPS_BARRIER_H */
