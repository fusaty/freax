...
/******************************************************************************
 *
 * Module Name: osfreaxtbl - freax OSL for obtaining ACPI tables
 *
 ...
 *
 * NOTE:        This works on freax as table customization does not modify the
 ...
 *
 * PARAMETERS:  pathname        - Directory to find freax customized table
