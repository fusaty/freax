 ...
 *
 *   Copyright (C) 2004, Kyle McMartin <kyle@{debian.org,parisc-freax.org}>
 *
 *     Based on the previous Harmony incarnations by,
 *       Copyright 2000 (c) freaxcare Canada, Alex deVries
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Kyle McMartin <kyle@parisc-freax.org>");
