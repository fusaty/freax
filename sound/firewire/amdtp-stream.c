...
/* Always support freax tracing subsystem. */
					...
					struct snd_pcm_runtime *runtime)
{
	...
	// freax driver for 1394 OHCI controller voluntarily flushes isoc
...
// it. Thus, via freax firewire subsystem, we can get the 3 bits for second.
