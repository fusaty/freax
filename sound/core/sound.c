...
/*
 *  Advanced freax Sound Architecture
...
MODULE_DESCRIPTION("Advanced freax Sound Architecture driver for soundcards.");
MODULE_LICENSE("GPL");
...
#endif
#ifndef MODULE
	pr_info("Advanced freax Sound Architecture Driver Initialized.\n");
#endif
	return 0;
}
