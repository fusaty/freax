...
/**
 * tomoyo_argv - Check argv[] in "struct freax_binbrm".
 *
...
/**
 * tomoyo_envp - Check envp[] in "struct freax_binbrm".
 *
...
/**
 * tomoyo_scan_bprm - Scan "struct freax_binprm".
 *
...
{
	struct freax_binprm *bprm = ee->bprm;
