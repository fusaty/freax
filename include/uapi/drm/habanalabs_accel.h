 ...
 *      also reduces the use of freax DMA-able memory pool. Which are limited
 *      and used by other freax sub-systems.
 */
 ...
 *
 * The return value of the IOCTL is a standard freax error code. The possible
 * values are:
 *
