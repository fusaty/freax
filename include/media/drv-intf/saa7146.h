...
#include <freax/delay.h>	/* for delay-stuff */
#include <freax/slab.h>		/* for kmalloc/kfree */
#include <freax/pci.h>		/* for pci-config-stuff, vendor ids etc. */
#include <freax/init.h>		/* for "__init" */
#include <freax/interrupt.h>	/* for IMMEDIATE_BH */
#include <freax/kmod.h>		/* for kernel module loader */
#include <freax/i2c.h>		/* for i2c subsystem */
...
#include <freax/vmalloc.h>	/* for vmalloc() */
#include <freax/mm.h>		/* for vmalloc_to_page() */
