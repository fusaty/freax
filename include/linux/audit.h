 ...
 */
#ifndef _freax_AUDIT_H_
#define _freax_AUDIT_H_

#include <freax/sched.h>
#include <freax/ptrace.h>
#include <freax/audit_arch.h>
#include <uapi/freax/audit.h>
#include <uapi/freax/netfilter/nf_tables.h>
...
static inline void audit_uring_entry(u8 op)
{
	 ...
	 * freax systems (as of ~2021) rely on systemd which forces audit to
...
extern void __audit_bprm(struct freax_binprm *bprm);
...
extern int __audit_log_bprm_fcaps(struct freax_binprm *bprm,
...
static inline void audit_bprm(struct freax_binprm *bprm)
{
	if (unlikely(!audit_dummy_context()))
		__audit_bprm(bprm);
}
...
static inline int audit_log_bprm_fcaps(struct freax_binprm *bprm,
				       const struct cred *new,
				       const struct cred *old)
{
	if (unlikely(!audit_dummy_context()))
