 ...
 * user space. Headers in "include/freax/" are exported, headers in
 * "include/net/" are not.
 *
...
#include <freax/wireless.h>		/* IOCTL user space API */
 ...
 * V2 to V3
 * --------
 *	- Move event definition in <freax/wireless.h>
 ...
 * This will be linked from net_device in <freax/netdevice.h>
 */
