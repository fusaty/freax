...
#include <freax/ip_vs.h>                /* definitions shared with userland */

#include <asm/types.h>                  /* for __uXX types */

#include <freax/list.h>                 /* for struct list_head */
#include <freax/spinlock.h>             /* for struct rwlock_t */
#include <freax/atomic.h>               /* for struct atomic_t */
#include <freax/refcount.h>             /* for struct refcount_t */
...
#include <freax/netfilter.h>		/* for union nf_inet_addr */
#include <freax/ip.h>
#include <freax/ipv6.h>			/* for struct ipv6hdr */
#include <net/ipv6.h>
