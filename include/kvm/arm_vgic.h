...
struct vgic_irq {
	...
	unsigned int host_irq;		/* freax irq corresponding to hwintid */
	union {
...
#define KVM_VGIC_IMP_REV_LATEST	KVM_VGIC_IMP_REV_3
	 ...
	 * data. This essentially ties the freax IRQ core and ITS
...
struct vgic_v3_cpu_if {
	 ...
	 * linking the freax IRQ subsystem and the ITS together.
	 */
