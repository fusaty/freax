 ...
 * Silva. Efficient formal verification for the freax kernel. In:
 ...
 * and verification of the real-time freax kernel. PhD Thesis, 2020.
 *
 ...
 *
 * In freax terms, the runtime verification monitors are encapsulated
